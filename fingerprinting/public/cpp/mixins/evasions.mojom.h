...
// template<> struct mojo::EnumTraits<::fingerprinting::mojom::EvasionsPack,
// ::fingerprinting::core::evasions::Package> {
//
//   static ::fingerprinting::mojom::EvasionsPack
//   ToMojom(::fingerprinting::core::evasions::Package package) {
...
//
// template <>
// struct EnumTraits<fingerprinting::mojom::HookTargetType,
// fingerprinting::mojom::HookTargetType> {
//   static fingerprinting::mojom::HookTargetType
//   ToMojom(fingerprinting::mojom::HookTargetType input) {
//     return input;
//   }
//
//   static bool FromMojom(fingerprinting::mojom::HookTargetType input,
//   fingerprinting::mojom::HookTargetType* output) {
//     *output = input;
//     return true;
//   }
// };
//
// template <>
// struct StructTraits<fingerprinting::mojom::EvasionsPackDataView,
// fingerprinting::mojom::EvasionsPack> {
//   static fingerprinting::mojom::HookTargetType target(const
//   fingerprinting::mojom::EvasionsPack& pack) {
//     return pack.target;
//   }
//
//   static const mojo_base::mojom::Value& hooks(const
//   fingerprinting::mojom::EvasionsPack& pack) {
//     return pack.hooks;
//   }
//
//   static bool Read(fingerprinting::mojom::EvasionsPackDataView data_view,
//   fingerprinting::mojom::EvasionsPack* out);
// };
