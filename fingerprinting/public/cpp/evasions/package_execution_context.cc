...
#include "fingerprinting/public/cpp/evasions/v8.h"
...
EvasionsPackageExecutionContext::EvasionsPackageExecutionContext(
    std::unique_ptr<::fingerprinting::core::evasions::EvasionsPackage> package,
    v8::Local<v8::Context> context,
    std::unique_ptr<::fingerprinting::Fingerprint> fingerprint)
    : context_(context), fingerprint_(std::move(fingerprint)) {
