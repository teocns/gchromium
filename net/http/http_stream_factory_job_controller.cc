...
int HttpStreamFactory::JobController::DoResolveProxy() {
  ...
  return session_->proxy_resolution_service()->ResolveProxyWithHeaders(
      origin_url, request_info_.method, request_info_.network_anonymization_key,request_info_.extra_headers,
