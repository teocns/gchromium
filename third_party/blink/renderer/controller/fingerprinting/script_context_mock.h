...
class CONTROLLER_EXPORT FingerprintScriptContextMock { 
 public:
  FingerprintScriptContextMock(const FingerprintScriptContextMock&) = delete;
  FingerprintScriptContextMock& operator=(const FingerprintScriptContextMock&) =
      delete;
  ~FingerprintScriptContextMock() final;

  // Only initializes if fingerprinting is enabled.
 ...
 private:
  // friend class FingerprintScriptContextMockTest;

  // explicit FingerprintScriptContextMock(
  //     mojo::PendingRemote<
